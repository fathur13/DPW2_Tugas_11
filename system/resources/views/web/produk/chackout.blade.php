            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="{{url('keranjang')}}">Checkout</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        ...
                        <label class="checkbox" for="ship-to-different-address-checkbox">KIRIM KE ALAMAT YANG BERBEDA?</label>
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-total">
                                                    <span class="amount">Rp.150.000</span> </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount">Rp.150.000</span>
                                                </td>
                                            </tr>
